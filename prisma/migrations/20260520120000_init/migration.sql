...
-- CreateEnum
CREATE TYPE "OrganizationRole" AS ENUM ('owner', 'project_admin');

-- CreateEnum
CREATE TYPE "ProjectRole" AS ENUM ('project_admin', 'member');

-- CreateEnum
CREATE TYPE "IssueType" AS ENUM ('task', 'bug', 'feature', 'improvement', 'epic', 'story');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('mention', 'assign', 'comment', 'status_change', 'sprint', 'invitation');
...
CREATE TABLE "OrganizationMember" (
    ...
    "role" "OrganizationRole" NOT NULL DEFAULT 'project_admin',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE INDEX "Invitation_email_projectId_idx" ON "Invitation"("email", "projectId");

-- CreateIndex
CREATE INDEX "Embedding_issueId_idx" ON "Embedding"("issueId");
...
-- AddForeignKey
ALTER TABLE "Embedding" ADD CONSTRAINT "Embedding_issueId_fkey" FOREIGN KEY ("issueId") REFERENCES "Issue"("id") ON DELETE CASCADE ON UPDATE CASCADE;
